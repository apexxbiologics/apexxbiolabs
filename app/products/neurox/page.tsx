  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        const neuroX = data.products.find((item: any) => {
          ...
          return (
            ...
            id === "neurox-48mg" ||
            id === "neuro-x-48mg" ||
            (name?.includes("neuro-x") && size === "48mg") ||
            (name?.includes("neurox") && size === "48mg") ||
        ...
        if (neuroX) {
          setInventory(Number(neuroX.inventory ?? 0));
          setPrice(Number(neuroX.price ?? 90));
        } else {
          setInventory(null);
          setPrice(90);
        }
        ...
        console.error(
          "Failed to fetch NEURO-X product data:",
          error
        );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-14 items-start">
            ...
            <div className="rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
              ...
              <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-6">
                NEURO-X is a multi-component research blend containing
                Semax, Selank, Pinealon, and PE-22-28 for laboratory
                investigation of peptide-associated cellular signaling,
      ...
      <section className="px-6 md:px-10 pb-16">
        ...
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">
            Multi-Peptide Research Overview
          </h2>

          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            NEURO-X combines Semax, Selank, Pinealon, and PE-22-28
            for laboratory investigation of peptide-associated
            biochemical pathways, cellular signaling mechanisms,
            and molecular interactions in experimental research models.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            ...
            {[
              [
                "Semax Research",
                "Studied in experimental models involving peptide-associated cellular signaling and molecular pathways.",
              ],

              [
                "Selank Research",
                "Evaluated in laboratory models involving peptide signaling and associated biochemical mechanisms.",
              ],

              [
                "Pinealon Research",
                "Investigated in experimental research involving peptide-associated cellular and molecular processes.",
              ],

              [
                "PE-22-28 Research",
                "Studied in laboratory models involving peptide-associated signaling pathways and molecular mechanisms.",
              ],
            ].map(([title, text]) => (
          ...
          <div className="mt-5 rounded-2xl border border-white/10 bg-white/[0.04] p-6">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Store refrigerated at 2–8°C. Keep sealed and protected
              from light until research use.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-4">
                Laboratory research involving peptide-associated
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-4">
                Experimental research involving peptide signaling
                and associated biochemical mechanisms.
              </p>
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-4">
                Laboratory investigation of peptide-associated
