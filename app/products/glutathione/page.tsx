  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        console.error(
          "Failed to fetch Glutathione data:",
          error
        );
            ...
            {[
              {
                ...
                text:
                  "Studied in laboratory models involving cellular energy, redox signaling, and metabolic pathways.",
              },
...

              {
                ...
                image:
                  "/images/ghkcublue.png",

                path:
                  "/products/ghkcu",

                text:
                  "Research involving cellular signaling, copper-binding pathways, and tissue-response models.",
              },
            ].map(
              (item) => (
                <a
