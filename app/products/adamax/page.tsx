      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#081526]/95 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-5 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-10 uppercase tracking-widest text-sm text-white">
            <a href="/" className="hover:text-[#A5D8FF] transition-all">
              Home
            </a>

            <a
              href="/products"
              className="text-[#A5D8FF] border-b border-[#A5D8FF] pb-2"
            >
              Products
            </a>

            <a href="/coas" className="hover:text-[#A5D8FF] transition-all">
              COAs
            </a>

            <a href="/contact" className="hover:text-[#A5D8FF] transition-all">
              Contact
            </a>
          </nav>
          ...
          <a
            href="/cart"
            className="relative text-white hover:text-[#A5D8FF] transition-all"
          >
