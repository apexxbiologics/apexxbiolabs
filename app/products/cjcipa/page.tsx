...
export default function CJCIPAWithoutDACPage() {
    ...
    />
            ...
            <div className="rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
              ...
              <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-6">
                High-purity CJC/IPA Without DAC research peptide blend intended
                strictly for laboratory research applications and analytical use.
              </p>
      ...
      <section className="px-6 md:px-10 pb-16">
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">
            Secretagogue Research Overview
          </h2>

          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            CJC/IPA Without DAC is studied in laboratory research models
            involving peptide-receptor interactions, endocrine signaling
            pathways, and secretagogue-related research applications.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              [
                "GHRH Pathway",
                "Studied in models involving growth hormone releasing hormone signaling.",
              ],
              [
                "Secretagogue Research",
                "Evaluated for peptide-receptor communication and endocrine pathway studies.",
              ],
              [
                "Peptide Blend Models",
                "Researched in controlled laboratory blend-response investigations.",
              ],
            ].map(([title, text]) => (
              <div
                key={title}
