  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        const glutathione = data.products.find((item: any) => {
          ...
          return (
            ...
            item.id === "glutathione" ||
            item.id === "glutathione-1500mg" ||
            item.id === "GLUTATHIONE-1500mg" ||
            (name?.includes("glutathione") && size === "1500mg") ||
            name?.includes("glutathione 1500")
          );
        });

        if (glutathione) {
          setInventory(Number(glutathione.inventory ?? 0));
          setPrice(Number(glutathione.price ?? 65));
        } else {
          setInventory(null);
          setPrice(65);
        }
      } catch (error) {
        console.error("Failed to fetch Glutathione data:", error);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-14 items-start">
            ...
            <div className="rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
              ...
              <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-6">
                High-purity glutathione research material studied in
                laboratory models involving cellular redox balance,
                oxidative stress pathways, antioxidant systems, and
                intracellular thiol regulation.
              </p>
        ...
        <div className="max-w-7xl mx-auto rounded-[32px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            [
              ShieldCheck,
              "Quality Focus",
              "Quality-focused laboratory research material.",
            ],
      ...
      <section className="px-6 md:px-10 pb-16">
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">
            Cellular Redox Research Overview
          </h2>

          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            Glutathione is a naturally occurring tripeptide commonly
            investigated in laboratory research involving cellular redox
            balance, oxidative stress response, thiol-dependent pathways,
            and intracellular antioxidant systems.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[
              [
                "Redox Research",
                "Studied in laboratory models involving cellular oxidation-reduction balance.",
              ],
              [
                "Oxidative Stress",
                "Evaluated in research involving cellular responses to oxidative conditions.",
              ],
              [
                "Thiol Pathways",
                "Investigated in biochemical models involving intracellular thiol regulation.",
              ],
              [
                "Storage",
                "Keep sealed and protected from excessive heat, moisture, and direct light according to laboratory storage requirements.",
              ],
            ].map(([title, text]) => (
              <div
                key={title}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-4">
                Studied in laboratory models involving cellular energy,
                redox signaling, and metabolic pathways.
              </p>
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-4">
                Research involving cellular signaling, copper-binding
                pathways, and tissue-response models.
              </p>
