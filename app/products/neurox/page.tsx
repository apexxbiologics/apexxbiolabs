          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-10 items-start">
            ...
            <div className="rounded-[32px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-6 md:p-8">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-4 mb-5">
                <p className="text-[10px] uppercase tracking-[0.3em] text-[#A5D8FF] mb-3">
                  Research
                  Formulation
                </p>
            ...
            {[
              {
                ...
                text:
                  "Laboratory research involving peptide-associated cellular signaling and molecular pathways.",
              },

              {
                ...
                text:
                  "Experimental research involving peptide signaling and associated biochemical mechanisms.",
              },

              {
                ...
                image:
                  "/images/pe2228blue.png",

                path:
                  "/products/pe2228",

                text:
                  "Laboratory investigation of peptide-associated signaling pathways and molecular mechanisms.",
              },
            ].map(
              (item) => (
                <a
