            ...
            {[
              {
                ...
                name: "Adamax",
                text: "Research involving metabolic regulation and performance-focused laboratory models.",
              },
              {
                href: "/products/motsc",
              ...
              },
              {
                ...
                name: "CJC/IPA",
                text: "Research involving growth hormone signaling pathways and endocrine response models.",
              },
            ].map((item) => (
              <a
                key={item.name}
