    ...
    const fetchProductData = async () => {
      try {
        ...
        const aod = data.products.find(
          (product: any) => product.slug === "aod9604-5mg"
        );

        setProductData({
          inventory: Number(aod?.inventory ?? 0),
          price: Number(aod?.price ?? 50),
        });
      } catch (error) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-14 items-start">
            ...
            <div className="rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
              ...
              <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-6">
                High-purity AOD-9604 produced for laboratory research involving
                growth hormone fragment studies, lipid metabolism pathways,
                metabolic signaling, and body composition research models.
              </p>
      ...
      <section className="px-6 md:px-10 pb-16">
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            AOD-9604 is a synthetic peptide fragment studied in laboratory
            research for its relationship to growth hormone fragment pathways,
            lipid metabolism, metabolic signaling, and body composition models.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[
              ["GH Fragment Research", "Studied as a modified fragment of human growth hormone."],
              ["Lipid Metabolism", "Evaluated in models involving fat metabolism and metabolic signaling."],
              ["Body Composition", "Frequently researched in body composition and metabolic regulation models."],
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12 mb-14">
          <div>
            ...
            <div className="flex gap-3 mt-6">
              <a href="https://www.tiktok.com/@apexx.nyc" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:border-blue-400/40 hover:bg-white/[0.07] transition-all">
                <FaTiktok size={18} />
              </a>

              <a href="https://x.com/ApexxBiolabsLLC" target="_blank" rel="noopener noreferrer" aria-label="X" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:border-blue-400/40 hover:bg-white/[0.07] transition-all">
                <FaXTwitter size={18} />
              </a>

              <a href="mailto:support@apexxbiolabs.com" aria-label="Email" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:border-blue-400/40 hover:bg-white/[0.07] transition-all">
