      ...
      <section className="px-6 md:px-10 pb-16">
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            Selank is studied in laboratory research involving neuropeptide
            signaling, stress-response pathways, immune-neural communication,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              [
                ...
                "Studied in laboratory models involving peptide-mediated neural communication.",
              ],
              [
                "Stress Response Research",
                "Evaluated in laboratory studies involving adaptive stress-response pathways.",
              ],
              [
                "Cognitive Models",
                "Investigated in research related to learning, memory, and neural pathway activity.",
              ],
            ].map(([title, text]) => (
              <div
                key={title}
