  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        const ss31 = data.products.find((item: any) => {
          ...
          return (
            ...
            item.id === "ss-31-10mg" ||
            item.id === "SS31-10mg" ||
            (name?.includes("ss-31") && size === "10mg") ||
            (name?.includes("ss31") && size === "10mg") ||
            name?.includes("ss-31 10") ||
            name?.includes("ss31 10")
          );
        });

        if (ss31) {
          setInventory(Number(ss31.inventory ?? 0));
          setPrice(Number(ss31.price ?? 45));
        } else {
          setInventory(null);
          setPrice(45);
        }
      } catch (error) {
        console.error("Failed to fetch SS-31 data:", error);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-14 items-start">
            ...
            <div className="rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
              ...
              <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-6">
                High-purity SS-31 research peptide studied in laboratory
                models involving mitochondrial function, cellular energy
                regulation, oxidative stress pathways, and mitochondrial
      ...
      <section className="px-6 md:px-10 pb-16">
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">
            Mitochondrial Research Overview
          </h2>

          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            SS-31 is studied in laboratory research models involving
            mitochondrial biology, cellular energetics, oxidative stress
            signaling, and mitochondrial membrane-associated processes.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[
              [
                ...
                "Studied in laboratory models involving mitochondrial activity and cellular energetics.",
              ],
              [
                "Membrane Research",
                "Evaluated in research involving mitochondrial membrane-associated processes.",
              ],
              [
                "Oxidative Stress",
                "Investigated in cellular models involving oxidative stress and redox signaling.",
              ],
              [
                "Storage",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-4">
                Research involving cellular energy, redox pathways, and
                metabolic signaling.
              </p>
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-4">
                Research involving cellular protection pathways and
                tissue-response signaling models.
              </p>
