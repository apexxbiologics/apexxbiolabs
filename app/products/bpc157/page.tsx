...
export default function BPC157Page() {
  ...
  const latestCoaPath =
    "/images/coas/bpc157-10mg-bpc102608-cblu-09-07-2026.pdf";

  const previousCoaPath =
    "/images/coas/bpc157coa7-10-26.pdf";

  const oldestCoaPath =
    "/images/coas/bpc-157-10mg-black-cap-coa.pdf";
      ...
      <section className="px-6 md:px-10 pb-14">
        <div className="max-w-7xl mx-auto rounded-[32px] border border-white/10 bg-white/[0.04] p-8">
          ...
          <p className="text-white/65 leading-relaxed max-w-4xl mb-7">
            BPC-157 is studied in
            laboratory research
            models involving tissue
            repair signaling,
            vascular pathway
            research,
            gastrointestinal
