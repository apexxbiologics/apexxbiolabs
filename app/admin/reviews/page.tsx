  ...
  return (
    <main className="min-h-screen bg-[#081526] text-white px-6 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-5xl font-black mb-10">Review Moderation</h1>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-3 text-sm text-white/60">
                ...
                <div className="flex flex-col gap-3 min-w-[160px]">
                  {!review.approved && (
                    <form action="/api/admin/reviews/approve" method="POST">
                      ...
                      <button
                        type="submit"
                        className="w-full rounded-full bg-green-500 text-white px-6 py-3 font-bold uppercase tracking-widest hover:bg-green-400 transition-all"
                      >
                        Approve
                      </button>
                    </form>
                  ...
                  {review.approved && (
                    <form action="/api/admin/reviews/unapprove" method="POST">
                      ...
                      <button
                        type="submit"
                        className="w-full rounded-full bg-yellow-500 text-[#081526] px-6 py-3 font-bold uppercase tracking-widest hover:bg-yellow-400 transition-all"
                      >
                        Unapprove
                      </button>
                    </form>
                  ...
                  <form action="/api/admin/reviews/delete" method="POST">
                    ...
                    <button
                      type="submit"
                      className="w-full rounded-full bg-red-500 text-white px-6 py-3 font-bold uppercase tracking-widest hover:bg-red-400 transition-all"
                    >
                      Delete
                    </button>
                  </form>
