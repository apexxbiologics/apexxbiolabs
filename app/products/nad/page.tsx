  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        const nad = productData.products.find(
          (item: any) =>
            item.slug === "nad" ||
    ...
    <main className="min-h-screen bg-[#081526] text-white overflow-hidden">
      ...
      <section className="px-6 md:px-10 pb-14">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-white/55 leading-relaxed max-w-3xl mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            {[
...

              {
                ...
                year: "2017",
                url:
                  "https://pmc.ncbi.nlm.nih.gov/articles/PMC5384578/",
              },
...

              {
                ...
                year: "Ongoing",
                url:
                  "https://clinicaltrials.gov/search?term=NAD%2B",
              },
            ].map(
              (paper) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group rounded-[24px] border border-white/10 bg-white/[0.04] p-5 hover:border-blue-400/40 hover:bg-white/[0.06] transition-all"
                >
                  <div className="flex items-center justify-between gap-3 mb-4">
                    <span className="rounded-full border border-blue-400/20 bg-blue-500/10 px-3 py-1.5 text-[#A5D8FF] text-[10px] font-bold uppercase tracking-widest">
                      {paper.type}
                    </span>
                  ...
                  <p className="text-[#A5D8FF] text-[10px] font-bold uppercase tracking-[0.2em] mb-3">
                    {paper.source}
                  </p>

                  <h3 className="text-lg font-black text-white leading-snug mb-3 group-hover:text-blue-200 transition-all">
                    {paper.title}
                  </h3>

                  <p className="text-white/45 text-sm italic mb-4">
                    {paper.authors}
                  </p>
          ...
          <p className="text-white/35 text-[10px] uppercase tracking-widest leading-relaxed mt-5">
            References are provided
            for educational research
            context only. Apexx
            Biolabs products are
            sold strictly for
