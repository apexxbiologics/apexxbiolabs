    ...
    const fetchProductData = async () => {
      try {
        ...
        const nad = data.products.find(
          (item: any) =>
            item.slug === "nad" ||
            item.slug === "nad-1000mg" ||
            item.id === "nad" ||
            item.id === "nad-1000mg" ||
            item.id === "NAD-1000mg" ||
            item.name?.toLowerCase().includes("nad")
        );

        if (nad) {
          setInventory(Number(nad.inventory ?? 0));
          setPrice(Number(nad.price ?? 45));
        } else {
          setInventory(null);
          setPrice(45);
        }
      } catch (error) {
        console.error("Failed to fetch NAD+ data:", error);
        setInventory(null);
        setPrice(45);
      }
    };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-14 items-start">
            ...
            <div className="rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
              ...
              <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-6">
                High-purity Nicotinamide Adenine Dinucleotide produced for
                laboratory research involving cellular metabolism, mitochondrial
                function, oxidative stress, aging biology, and energy production
                pathways.
              </p>
        ...
        <div className="max-w-7xl mx-auto rounded-[32px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-6">
          <div className="grid md:grid-cols-[1fr_auto] gap-6 items-center">
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <a
                href="/images/coas/nadcoa7-20-26.pdf"
                target="_blank"
      ...
      <section className="px-6 md:px-10 pb-16">
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            NAD+ is a naturally occurring coenzyme essential for cellular energy
            production and redox reactions. Laboratory research commonly
            investigates its role in mitochondrial function, DNA repair,
            oxidative stress, aging biology, and metabolic regulation.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[
              [
                "Energy Metabolism",
                "Studied for ATP production and mitochondrial bioenergetics.",
              ],
              [
                "Cellular Repair",
                "Investigated in NAD-dependent DNA repair pathways.",
              ],
              [
                "Healthy Aging",
                "Frequently researched in longevity and sirtuin activation models.",
              ],
              [
                "Storage",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-white/60 text-lg leading-relaxed max-w-3xl">
              ...
              related to NAD+ biology, cellular metabolism, mitochondrial
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {[
              ...
              {
                type: "Metabolism Research",
                source: "Cell Metabolism",
                title:
                  "NAD+ Metabolism and the Control of Energy Homeostasis",
                authors: "Cantó C, et al.",
                year: "2015",
                url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC4487780/",
              },
              {
                type: "Review Article",
                ...
                year: "2020",
                url: "https://pubmed.ncbi.nlm.nih.gov/31917996/",
              },
              {
                type: "DNA Repair",
                ...
                authors: "Croteau DL, et al.",
                year: "2017",
                url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC5384578/",
              },
              {
                ...
                authors: "Radenkovic D, et al.",
                year: "2020",
                url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC7558103/",
              },
              {
                type: "Clinical Registry",
                source: "ClinicalTrials.gov",
                title: "NAD+ and NAD-Related Clinical Research Registry",
                authors: "ClinicalTrials.gov",
                year: "Ongoing",
                url: "https://clinicaltrials.gov/search?term=NAD%2B",
              },
            ].map((paper) => (
              <a
                key={paper.title}
