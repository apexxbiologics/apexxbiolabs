          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-9 sm:gap-14 items-start">
            ...
            <div>
              <div className="flex items-center justify-center">
                <div className={`relative w-full max-w-[520px] aspect-square rounded-[32px] sm:rounded-[48px] overflow-hidden border border-blue-400/10 backdrop-blur-sm shadow-[0_0_30px_rgba(96,165,250,0.15)] ${
                      selectedImage === 0 ? "bg-[#91C2FD]" : "bg-[#9CC4FD]"
                    }`}>
