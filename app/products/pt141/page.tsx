    ...
    const fetchProductData = async () => {
      try {
        ...
        const pt141 = data.products.find(
          (product: any) => product.slug === "pt141-10mg"
        );

        setProductData({
          inventory: Number(pt141?.inventory ?? 0),
          price: Number(pt141?.price ?? 55),
        });
      } catch (error) {
      ...
      <section className="px-6 md:px-10 pb-16">
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            PT-141, also known as bremelanotide in clinical research literature,
            is studied for melanocortin receptor activity and neuroendocrine
            signaling pathways in controlled laboratory models.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[
              ["Melanocortin Pathways", "Studied for activity involving melanocortin receptor signaling."],
              ["Neuroendocrine Research", "Evaluated in models involving central nervous system signaling pathways."],
              ["Receptor Activity", "Frequently researched in peptide-receptor interaction studies."],
