...
export default function Kisspeptin10Page() {
  ...
  const latestCoaPath =
    "/images/coas/9-22-kisspeptin-coa.pdf";
  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        console.error(
          "Failed to fetch Kisspeptin-10 data:",
          error
        );
            ...
            {[
              {
                ...
                image:
                  "/images/pt141blue.png",

                path:
                  "/products/pt141",

                text:
                  "Studied in neuroendocrine signaling and melanocortin receptor pathway research models.",
              },
