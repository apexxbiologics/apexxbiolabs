...
export default function WolverinePage() {
  ...
  const products = [
    ...
    { name: "KLOW", keywords: ["klow", "k-low", "k low"], path: "/products/klow" },
    ...
    { name: "Wolverine", keywords: ["wolverine", "wol", "bpc tb", "bpc-157 tb-500"], path: "/products/wolverine" },
  ];
  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        setProductData({
          inventory: Number(wolverine?.inventory ?? 0),
          price: Number(wolverine?.price ?? 75),
        });
      } catch (error) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-14 items-start">
            ...
            <div className="rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
              ...
              <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-6">
                High-purity Wolverine blend produced for laboratory research
                involving peptide signaling, tissue-repair pathway models,
                recovery-related research, and controlled regenerative studies.
              </p>
      ...
      <section className="px-6 md:px-10 pb-16">
        <div className="max-w-7xl mx-auto rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-sm p-8 md:p-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">
            Wolverine Research Overview
          </h2>

          <p className="text-white/70 text-lg leading-relaxed max-w-4xl mb-8">
            Wolverine is studied in laboratory research models involving
            peptide-based signaling, tissue-repair pathways, inflammatory
            response models, and regenerative research applications.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[
              ["Peptide Blend Research", "Studied in controlled peptide-combination laboratory models."],
              ["Tissue Pathways", "Evaluated in models involving tissue-repair and recovery-related signaling."],
              ["Regenerative Models", "Frequently researched in regenerative and inflammatory response studies."],
