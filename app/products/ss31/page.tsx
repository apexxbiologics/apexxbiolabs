  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        if (ss31) {
          setInventory(
            Number(ss31.inventory ?? 0)
          );

          setPrice(
            Number(ss31.price ?? 45)
          );
        } else {
          setInventory(null);
          setPrice(45);
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            {[
...

              {
                ...
                text:
                  "Research involving cellular energy, redox pathways, and metabolic signaling.",
              },

              {
                ...
                text:
                  "Research involving cellular protection pathways and tissue-response signaling models.",
              },
            ].map((item) => (
